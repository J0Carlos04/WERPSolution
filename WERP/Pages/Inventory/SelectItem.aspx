<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectItem.aspx.cs" Inherits="Pages_SelectItem" %>
      ...
      <Content>                  
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" Width="100%" HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvData_RowDataBound">
          <Columns>            
            ...
            <asp:TemplateField HeaderText="Stock Qty" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_StockQty" Text='<%# Eval("StockQty") %>' /></ItemTemplate></asp:TemplateField>            
