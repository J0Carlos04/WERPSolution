...
public partial class Pages_Inventory_StockOut : PageBase
{    
    #region Handlers
    ...
    protected void lb_Click(object sender, EventArgs e)
    {
        ...
        {
            case "lbEdit":
                U.OpenNewTab("EditStockOut", "Edit Stock Out", $"getEditWindowUrl('{lb.CommandArgument}')");
                break;           
            case "lbRetur":
                U.OpenNewTab("NewStockOutRetur", "New Stock Out Retur", $"getReturWindowUrl('{lb.CommandArgument}')");
                break;
            case "lb_ItemCode":
    ...
    protected void gvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {            
            ...
            Literal ltrl_UnusedQty = (Literal)e.Row.FindControl("ltrl_UnusedQty");
            LinkButton lbRetur = (LinkButton)e.Row.FindControl("lbRetur");
            if (ltrl_UnusedQty.Text.ToInt() == 0) lbRetur.Visible = false;
    ...
    private void SetInit()
    {
        ...
        btnSearch.OnClientClick = $"{wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=StockOutItem")}return false;";
        btnSorting.OnClientClick = $"{wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=StockOutItem")}return false;";
    }
    ...
    private void SetInitAdd()
    {
        ...
        joBuilder.AddProperty("id", "NewStockOut");
        joBuilder.AddProperty("title", "New Stock Out");
    ...
    private object SetCriteria(object Criteria)
    {
        if (!U.WorkOrderId.IsNull())
        {
            ...
            Criteria = $"{Criteria} b.WorkOrderId = '{U.WorkOrderId}' ";
        }        
        return Criteria;
    }
    private void Search()
    ...
    {
        oList.Add(new StockOutItem() { No = -1, ItemName = CNT.DataNotAvailable });
    ...
    private void ExportExcel()
    {
        ...
        List<object> oList = StockOutItem.GetByCriteria(pList, out double TotalRow);
        ...
        w.SetExcel("Rack");
        w.SetExcel("Qty");
        w.SetExcel("Unused Qty");
        w.SetExcel("Used Qty");
        w.SetExcel("Retur Qty");
        w.SetExcel("SKU");
        w.SetExcel("OutDate");
        w.SetExcel("StockOut Code");
        w.SetExcel("Work Order");
        #endregion
        ...
        foreach (StockOutItem o in oList)
        {
            ...
            w.SetExcel(o.Rack);
            w.SetExcel(o.Qty);
            w.SetExcel(o.UnusedQty);
            w.SetExcel(o.UsedQty);
            w.SetExcel(o.ReturQty);
            w.SetExcel(o.SKU);
            w.SetExcel(o.OutDate);
            w.SetExcel(o.StockOutCode);
            w.SetExcel(o.WorkOrder);
            w.Column = 0;
        }
        #endregion
