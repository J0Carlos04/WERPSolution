...
public partial class Pages_Inventory_StockOutRetur : PageBase
{
    #region Fields   
    ...
    protected void lb_Click(object sender, EventArgs e)
    {
        ...
        {
            case "lbEdit":
                U.OpenNewTab("EditStockOutRetur", "Edit Stock Out Retur", $"getEditWindowUrl('{lb.CommandArgument}', '{lb.CommandName}')");
                break;
        }
    }
    ...
    protected void ucPaging_OpChanged(object sender, EventArgs e)
    {
        ...
        List<object> oList = oList = StockOutRetur.GetByCriteria(pList, out double TotalRow);
    ...
    protected void wSearch_Close(object sender, F.WindowCloseEventArgs e)
    {
        ...
        btnSearch.OnClientClick = wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=StockOutRetur&SearchData={arrArgument[1].Replace(Environment.NewLine, "~")}");
    ...
    protected void wSort_Close(object sender, F.WindowCloseEventArgs e)
    {
        ...
        btnSorting.OnClientClick = wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=StockOutRetur&SortData={arrArgument[1].Replace(Environment.NewLine, "~")}");
    ...
    protected string GetEditUrl(object id, object StockOutItemId)
    {
        ...
        joBuilder.AddProperty("id", "EditStockOutRetur");
    ...
    {
        F.JsObjectBuilder joBuilder = new F.JsObjectBuilder();
        joBuilder.AddProperty("id", "StockOutReturInput");
    ...
    private void SetInit()
    {
        ...
        btnSearch.OnClientClick = $"{wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=StockOutRetur")}return false;";
        btnSorting.OnClientClick = $"{wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=StockOutRetur")}return false;";
    }
    ...
    {
        F.JsObjectBuilder joBuilder = new F.JsObjectBuilder();
        joBuilder.AddProperty("id", "NewStockOutRetur");
        joBuilder.AddProperty("title", "New Stock Out Retur");
    ...
    private void BindData()
    {
        ...
        List<object> oList = StockOutRetur.GetByCriteria(pList, out TotalRow);
    ...
    {
        oList.Add(new StockOutRetur() { No = -1, Code = CNT.DataNotAvailable });
    ...
    private void ExportExcel()
    {
        ...
        List<object> oList = StockOutRetur.GetByCriteria(pList, out double TotalRow);
        ...
        foreach (StockOutRetur o in oList)
        {
            w.Row += 1;
        ...
        resp.Clear();
        resp.Buffer = false;
        resp.AppendHeader("content-disposition", string.Format("attachment; filename=StockOutRetur.xlsx"));
        ...
        byte[] buffer = null;
        string tempFilename = $@"{U.PathTempFolder}StockOutRetur.xlsx";
