<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockReceivedReturInput.aspx.cs" Inherits="Pages_Inventory_StockReceivedReturInput" %>
...
<f:PageManager ID="pm" AutoSizePanelID="pContent" runat="server" Language="EN" AjaxAspnetControls="pnlContent" /> 
    ...
    <Toolbars>
      <f:Toolbar runat="server" ID="tlb">
        <Items>
          ...
          <f:Button runat="server" ID="btnDelete" Text="Delete" Icon="DatabaseDelete" OnClick="Fbtn_Click" ConfirmText="Are you sure you want to delete this Stock Received Retur?. This action cannot be undone. Do you wish to proceed?" ConfirmIcon="Warning"  />
      ...
      <f:ContentPanel runat="server" ID="pData" ShowBorder="true" AutoScroll="true"  >
        <Content><div class="wrapper-suppress"><asp:Panel runat="server" ID="pnlContent">
          ...
          <div class="row mb-3">            
            ...
            <div class="col-sm-10">
              <div class="input-group mb-3">
                <input runat="server" type="text" id="tbItemCodeLookup" class="form-control form-control-sm" placeholder="Select Stock Received" aria-label="select Stock Order" aria-describedby="basic-addon2" readonly />
                <div class="input-group-append"><asp:Button runat="server" ID="btnSelectStockReceivedItemCode" Text="Lookup" CssClass="btn btn-primary btn-sm" /></div>
              </div>
            </div>
          </div>
          </asp:Panel>
          ...
          <div class="form-group row" style="margin-bottom:10px;">
            <label for="tbItemName" class="col-sm-2 col-form-label col-form-label-sm">Item Name</label>
          ...
          <div class="form-group row" style="margin-bottom:10px;">
            <label for="tbAvailableQty" class="col-sm-2 col-form-label col-form-label-sm">Available Qty</label>
            <div class="col-sm-10"><input runat="server" id="tbAvailableQty" type="text" class="form-control-plaintext" style="padding-left:10px;" readonly /></div>
          </div>
          <div class="row mb-3">
  ...
  <f:Window ID="wSR" Title="Select Stock Received" Hidden="true" EnableIFrame="true" runat="server" EnableMaximize="true" EnableResize="true" Target="Top" IsModal="false" Width="830px" Height="500px" OnClose="wSR_Close"></f:Window>  
</form>
</body>
</html>
