...
public partial class Pages_Inventory_SelectSR : PageBase
{
    #region Fields   
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        switch (btn.ID)
        {
            case "btnInvoiceFileName":
                DownloadFile(btn, "lb_InvoiceFileName");
                break;
            case "btnBastFileName":
    ...
    {
        btnSearch.OnClientClick = wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=StockReceivedItem");
        btnSearch.OnClientClick += "return false;";
        btnSorting.OnClientClick = wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=StockReceivedItem");
        btnSorting.OnClientClick += "return false;";
    ...
    private object SetCriteria(object Criteria)
    {
        ...
        Criteria = $"{Criteria} ISNULL(a.AvailableQty, 0) <> 0 ";        
        return Criteria;
    }
    ...
    {
        oList.Add(new StockReceivedItem() { No = -1, ItemCode = CNT.DataNotAvailable });
        ups.Enabled = false;
