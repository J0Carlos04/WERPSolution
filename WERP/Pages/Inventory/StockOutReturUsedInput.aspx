<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockOutReturUsedInput.aspx.cs" Inherits="Pages_Inventory_StockOutReturUsedInput" %>
    ...
    <Items>
      <f:ContentPanel runat="server" ID="pData" ShowBorder="true" AutoScroll="true"  >
        <Content><div class="wrapper-suppress"><asp:Panel runat="server" ID="pnlContent">
          ...
          <asp:Panel runat="server" ID="pnlWorkOrder" Visible="false" style="margin-bottom:15px;">
            <div class="row mb-3">
          ...
          <asp:Panel runat="server" ID="pnlWorkOrderLookup" style="margin-bottom:15px;">
            <div class="row mb-3">            
              <label class="col-sm-2 col-form-label col-form-label-sm">Work Order<span class="Req">*</span></label>          
              <div class="col-sm-10">
          ...
          <div class="form-group row">
            <label for="tbItemName" class="col-sm-2 col-form-label">Work Update<span class="Req">*</span></label>
            <div class="col-sm-10"><asp:DropDownList runat="server" id="ddlWorkUpdate" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged" class="form-select form-select-sm" /></div>
          </div>

          <div class="form-group row" style="margin-top:15px;">
            <label for="tbItemName" class="col-sm-2 col-form-label">Work Update Item<span class="Req">*</span></label>
            <div class="col-sm-10"><asp:DropDownList runat="server" id="ddlWorkUpdateItem" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged" class="form-select form-select-sm" /></div>
          </div>          
          <div class="form-group row">
            <label for="tbItemName" class="col-sm-2 col-form-label">SKU</label>
            <div class="col-sm-10"><input runat="server" id="tbSKU" type="text" readonly class="form-control-plaintext" style="padding-left:10px;" /></div>
          </div>                          
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label col-form-label-sm">Retur Qty<span class="Req">*</span></label>
            <div class="col-sm-10"><input runat="server" id="tbReturQty" type="text" readonly class="form-control-plaintext" style="padding-left:10px;" /></div>
          </div> 
          
          <div class="form-group row" style="margin-top:-15px;">
            <label for="tbItemName" class="col-sm-2 col-form-label">Warehouse<span class="Req">*</span></label>
            <div class="col-sm-10"><asp:DropDownList runat="server" id="ddlWarehouse" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged" class="form-select form-select-sm" /></div>
          </div>

          <div class="form-group row" style="margin-top:15px;">
            <label for="tbItemName" class="col-sm-2 col-form-label">Rack<span class="Req">*</span></label>
            <div class="col-sm-10"><asp:DropDownList runat="server" id="ddlRack" AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged" class="form-select form-select-sm" /></div>
          </div>
