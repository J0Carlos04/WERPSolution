<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeteranganCatat.aspx.cs" Inherits="Pages_DataPerumda_KeteranganCatat" %>
      ...
      <Content><div class="wrapper-suppress">                  
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="gvData_RowDataBound" Width="100%" HeaderStyle-HorizontalAlign="Center">
          <Columns>            
            ...
            <asp:TemplateField HeaderText="kd_ketcatat" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_kd_ketcatat" Text='<%# Eval("kd_ketcatat") %>' /></ItemTemplate></asp:TemplateField>
