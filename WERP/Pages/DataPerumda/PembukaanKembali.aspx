<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PembukaanKembali.aspx.cs" Inherits="Pages_DataPerumda_PembukaanKembali" %>
      ...
      <Content><div class="wrapper-suppress">                 
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="gvData_RowDataBound" Width="100%" HeaderStyle-HorizontalAlign="Center">
          <Columns>            
            ...
            <asp:TemplateField HeaderText="no_mohonan_pk" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_no_mohonan_pk" Text='<%# Eval("no_mohonan_pk") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="tgl_pasanglagi" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_tgl_pasanglagi" Text='<%# Eval("tgl_pasanglagi") %>' /></ItemTemplate></asp:TemplateField>            
