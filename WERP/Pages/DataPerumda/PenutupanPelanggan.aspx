<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PenutupanPelanggan.aspx.cs" Inherits="Pages_DataPerumda_PenutupanPelanggan" %>
      ...
      <Content><div class="wrapper-suppress">                 
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="gvData_RowDataBound" Width="100%" HeaderStyle-HorizontalAlign="Center">
          <Columns>            
            ...
            <asp:TemplateField HeaderText="tgl_tutup" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_tgl_tutup" Text='<%# Eval("tgl_tutup") %>' /></ItemTemplate></asp:TemplateField>            
            ...
            <asp:TemplateField HeaderText="stand_angkat" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_stand_angkat" Text='<%# Eval("stand_angkat") %>' /></ItemTemplate></asp:TemplateField>            
        </Columns>
