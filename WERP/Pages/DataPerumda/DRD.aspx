<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DRD.aspx.cs" Inherits="Pages_DataPerumda_DRD" %>
      ...
      <Content><div class="wrapper-suppress">                    
        <asp:GridView runat="server" ID="gvData" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="gvData_RowDataBound" Width="100%" HeaderStyle-HorizontalAlign="Center">
          <Columns>            
            ...
            <asp:TemplateField HeaderText="airkotor" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_airkotor" Text='<%# Eval("airkotor") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="beabeban" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_beabeban" Text='<%# Eval("beabeban") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="beaadmin" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_beaadmin" Text='<%# Eval("beaadmin") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="tjtg" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_tjtg" Text='<%# Eval("tjtg") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="jmlreknunggak" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_jmlreknunggak" Text='<%# Eval("jmlreknunggak") %>' /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField HeaderText="tagnunggak" ><ItemTemplate><asp:Literal runat="server" ID="ltrl_tagnunggak" Text='<%# Eval("tagnunggak") %>' /></ItemTemplate></asp:TemplateField>
