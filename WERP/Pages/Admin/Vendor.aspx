<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor.aspx.cs" Inherits="Pages_Vendor" %>
...
<f:Panel ID="pContent" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region" EnableAjaxLoading="true" AjaxLoadingType="Default">
  <Toolbars>
    <f:Toolbar runat="server" ID="tTop" Position="Top"><Items>
      ...
      <f:Button runat="server" ID="btnDelete" Text="Delete" Icon="Delete" OnClick="btn_Click" ConfirmText="Are you sure you want to delete this Vendor?. This action cannot be undone. Do you wish to proceed?" ConfirmIcon="Warning"  />
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="Code" >              
              <ItemTemplate>		    
                ...
                <asp:TextBox runat="server" ID="tb_Code" Text='<%# $"{Eval("Mode")}" == "add" ? "" : $"{Eval("Code")}" %>' Visible='<%# !Eval("Mode").IsEmpty() %>' CssClass="form-control form-control-sm" />
              </ItemTemplate>
            </asp:TemplateField> 
            ...
            <asp:TemplateField HeaderText="Contact Person" >              
              <ItemTemplate>		    
                <asp:Literal runat="server" ID="ltrlContactPerson" Text='<%# Eval("ContactPerson") %>' Visible='<%# Eval("Mode").IsEmpty() %>' />                        
                <asp:TextBox runat="server" ID="tb_ContactPerson" Text='<%# $"{Eval("Mode")}" == "add" ? "" : $"{Eval("ContactPerson")}" %>' Visible='<%# !Eval("Mode").IsEmpty() %>' CssClass="form-control form-control-sm" />
              </ItemTemplate>
            </asp:TemplateField>
