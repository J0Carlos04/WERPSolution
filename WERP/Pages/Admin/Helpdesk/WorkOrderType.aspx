<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkOrderType.aspx.cs" Inherits="Pages_Admin_Helpdesk_WorkOrderType" %>
...
<f:Panel ID="pContent" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region" EnableAjaxLoading="true" AjaxLoadingType="Default">
  <Toolbars>
    <f:Toolbar runat="server" ID="tTop" Position="Top"><Items>
      ...
      <f:Button runat="server" ID="btnDelete" Text="Delete" Icon="Delete" OnClick="btn_Click" ConfirmText="Are you sure you want to delete this Work Order Type?. This action cannot be undone. Do you wish to proceed?" ConfirmIcon="Warning" />
