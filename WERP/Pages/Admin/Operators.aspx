<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Operators.aspx.cs" Inherits="Pages_Admin_Operators" %>
...
<f:Panel ID="pContent" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region" EnableAjaxLoading="true" AjaxLoadingType="Default">
  <Toolbars>
    <f:Toolbar runat="server" ID="tTop" Position="Top"><Items>
      ...
      <f:Button runat="server" ID="btnDelete" Text="Delete" Icon="Delete" OnClick="btn_Click" ConfirmText="Are you sure you want to delete this Operator?. This action cannot be undone. Do you wish to proceed?" ConfirmIcon="Warning" />
      <f:Button runat="server" ID="btnResetPassword" Text="Reset Password" Icon="ResetPassword" OnClick="btn_Click" />
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="Address" >              
              <ItemTemplate>		    
                ...
                <asp:TextBox runat="server" ID="tb_Address" Text='<%# $"{Eval("Mode")}" == "add" ? "" : $"{Eval("Address")}" %>' Visible='<%# !Eval("Mode").IsEmpty() %>' CssClass="form-control form-control-sm" />
              </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Phone" >              
              <ItemTemplate>		    
                <asp:Literal runat="server" ID="ltrlPhone" Text='<%# Eval("Phone") %>' Visible='<%# Eval("Mode").IsEmpty() %>' />                        
                <asp:TextBox runat="server" ID="tb_Phone" Text='<%# $"{Eval("Mode")}" == "add" ? "" : $"{Eval("Phone")}" %>' TextMode="Number" Visible='<%# !Eval("Mode").IsEmpty() %>' CssClass="form-control form-control-sm" />
              </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Vendor" >              
              <ItemTemplate>		    
                <asp:Literal runat="server" ID="ltrl_Vendor" Text='<%# Eval("Vendor") %>' Visible='<%# Eval("Mode").IsEmpty() %>' />                        
                <asp:DropDownList runat="server" ID="ddl_VendorId" Visible='<%# !Eval("Mode").IsEmpty() %>' CssClass="form-select form-select-sm" />
              </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Username" >              
              <ItemTemplate>		    
                <asp:Literal runat="server" ID="ltrlUsername" Text='<%# Eval("Username") %>' Visible='<%# Eval("Mode").IsEmpty() || Eval("Mode").ToText() == "edit" %>' />                        
                <asp:TextBox runat="server" ID="tb_Username" Text='<%# $"{Eval("Mode")}" == "add" ? "" : $"{Eval("Username")}" %>' Visible='<%# Eval("Mode").ToText() == "add" %>' CssClass="form-control form-control-sm" />
              </ItemTemplate>
            </asp:TemplateField>
