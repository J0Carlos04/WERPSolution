...
public partial class Pages_WorkOrder_ScheduleMaintenance : PageBase
{
    #region Fields 
    ...
    protected void lb_Click(object sender, EventArgs e)
    {
        ...
        {
            case "lbEdit":
                U.OpenNewTab("EditMaintenanceScheduler", "Edit Maintenance Scheduler", $"getEditWindowUrl('{lb.CommandArgument}')");
                break;
            case "lbOrder":
                U.OpenNewTab($"View{lb.CommandName}WorkOrder", $"View {lb.CommandName} Work Order", $"getOrderWindowUrl('{lb.CommandArgument}')");
                break;
        }
    }
    ...
    protected void ucPaging_OpChanged(object sender, EventArgs e)
    {
        ...
        List<object> oList = oList = ScheduleMaintenance.GetByCriteria(pList, out double TotalRow);
    ...
    protected void wSearch_Close(object sender, F.WindowCloseEventArgs e)
    {
        ...
        btnSearch.OnClientClick = wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=ScheduleMaintenance&SearchData={arrArgument[1].Replace(Environment.NewLine, "~")}");
    ...
    protected void wSort_Close(object sender, F.WindowCloseEventArgs e)
    {
        ...
        btnSorting.OnClientClick = wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=ScheduleMaintenance&SortData={arrArgument[1].Replace(Environment.NewLine, "~")}");
    ...
    private void SetInit()
    {
        ...
        btnSearch.OnClientClick = $"{wSearch.GetShowReference($"~/Pages/Search.aspx?ClassName=ScheduleMaintenance")}return false;";
        btnSorting.OnClientClick = $"{wSort.GetShowReference($"~/Pages/Sort.aspx?ClassName=ScheduleMaintenance")}return false;";
    }
    ...
    private void SetInitAdd()
    {
        ...
        joBuilder.AddProperty("id", "NewMaintenanceScheduler");
        joBuilder.AddProperty("title", "New Maintenance Scheduler");
    ...
    private void BindData()
    {
        ...
        List<object> oList = ScheduleMaintenance.GetByCriteria(pList, out TotalRow);
    ...
    {
        oList.Add(new ScheduleMaintenance() { No = -1, Subject = CNT.DataNotAvailable });
    ...
    private void ExportExcel()
    {
        ...
        List<object> oList = ScheduleMaintenance.GetByCriteria(pList, out double TotalRow);
        ...
        w.SetExcel("Area");
        w.SetExcel("Location");
        w.SetExcel("Work Order Category");
        ...
        foreach (ScheduleMaintenance o in oList)
        {
            w.Row += 1;
            ...
            w.SetExcel(o.WorkOrderCategory);
