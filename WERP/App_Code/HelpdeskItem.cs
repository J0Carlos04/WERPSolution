...
public class HelpdeskItem
{
    ...
    {
        return DataAccess.GetDataByQuery(0, $"Select a.*, b.Code ItemCode, b.Name ItemName from HelpdeskItem a Left Join Item b On b.Id = a.ItemId where a.HelpdeskId = '{HelpdeskId}'", new HelpdeskItem());
    }
    #endregion
    #region Changed Data
    public string Insert()
    {
        ...
        return DataAccess.Save(0, "HelpdeskItemInsert", pList);
    }
    public string Update()
    {
        ...
        pList.Add(new clsParameter("Qty", Qty));
        pList.Add(new clsParameter("Author", CreatedBy));
        return DataAccess.Save(0, "HelpdeskItemUpdate", pList);
    }
    public string Delete()
    {
        return DataAccess.Delete(0, Id, "Id", "HelpdeskItem");
    }
    #endregion
    #endregion
}