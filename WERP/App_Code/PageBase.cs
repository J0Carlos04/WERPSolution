    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (pm != null && !pm.IsFineUIAjaxPostBack)
        {
            ...
            if (themeCookie != null)
            {
                ...
                {
                    pm.Theme = FineUI.Theme.Gray;
                }
                U.AddClassToClass("squareboxgradientcaption", themeCookie.Value);
            }
            else U.AddClassToClass("squareboxgradientcaption", "gray");

            HttpCookie langCookie = Request.Cookies["Language_v6"];
            pm.Language = Language.EN;
        ...
        try
        {
            ...
            if (Header != null) Header.Controls.AddAt(0, metaCtrl);
            ...
            if (Header != null) Header.Controls.Add(linkCtrl);
        }
        catch (Exception ex)
        {
