    ...
    F.util = {
        ...
        hidePageLoading: function () {
            ...
            */
            ...
            Ext.get("f_loading").hide();
            Ext.get("f_loading_mask").hide();
        },
        ...
        */
        ...
        addMainTab: function (mainTabStrip, tabOptions) {
            ...
            */
            ...
            } else if (typeof (tabOptions) === 'object' && tabOptions.data) {
                var paramTreeNode = tabOptions;
                tabOptions = {
                    id: paramTreeNode.getId(),
                    iframeUrl: paramTreeNode.data.href,
                    title: paramTreeNode.data.text,
                    icon: paramTreeNode.data.icon,
            ...
            var currentTab = mainTabStrip.getTab(tabOptions.id);
            if (!currentTab) {
                var tabConfig = {
                    'id': tabOptions.id,
                ...
                currentTab.setTitle(tabOptions.title);
                if (tabOptions.icon) {
        ...
        initTreeTabStrip: function (treeMenu, mainTabStrip, createToolbar,
            ...
            function registerTreeClickEvent(treeInstance) {
                ...
                // https://www.sencha.com/forum/showthread.php?286719-preventDefault-does-not-work-on-IE10-IE11
...
(function () {
    ...
    function showMaskAjaxLoading() {
        ...
        loadingMaskNode.show();
        loadingNode.show();
    }


    function hideMaskAjaxLoading() {
        Ext.get('f_ajax_loading_mask_mask').hide();
        Ext.get('f_ajax_loading_mask').hide();
    }
    ...
    function _showAjaxLoading(ajaxLoadingType) {
        ...
        if (__ajaxUnderwayCount > 0) {
            ...
            if (ajaxLoadingType === "default") {
                ...
                //Ext.getBody().mask(F.util.loading);
                showMaskAjaxLoading();
            }
...
if (Ext.grid.Panel) {
    Ext.override(Ext.grid.Panel, {
        ...
        */
        ...
        var checkboxRows = gridEl.select('.x-grid-body .x-grid-item .x-grid-td-' + columns[columnIndex].id + ' .f-grid-checkbox');
        ...
        */
        ...
        f_getStates: function () {
            ...
            function getCheckBoxStates(columnIndex) {
                var checkboxRows = gridEl.select('.x-grid-item .x-grid-cell-' + columns[columnIndex].id + ' .f-grid-checkbox');
                var columnStates = [];
